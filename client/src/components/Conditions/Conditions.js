...
const Conditions = (props) => {
    return (
        <div style={{background: "rgba(128, 128, 128, 0.5)", width: "100%", borderRadius: ".5rem"}}>
            {props.responseObj.cod === "200" ?
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                             <img alt="weather-icon" src={"http://openweathermap.org/img/wn/" + props.responseObj.list[0].weather[0].icon + "@2x.png"}></img>
                        </div>
                        <div className="col-6">
                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                             <img alt="weather-icon" src={"http://openweathermap.org/img/wn/" + props.responseObj.list[1].weather[0].icon + "@2x.png"}></img>
                        </div>
                        <div className="col-6">
                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                             <img alt="weather-icon" src={"http://openweathermap.org/img/wn/" + props.responseObj.list[2].weather[0].icon + "@2x.png"}></img>
                        </div>
                        <div className="col-6">
